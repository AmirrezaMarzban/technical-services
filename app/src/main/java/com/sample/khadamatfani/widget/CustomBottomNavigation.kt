package com.sample.khadamatfani.widget
...
class CustomBottomNavigationView : BottomNavigationView {
    ...
    private val CURVE_CIRCLE_RADIUS = 60 / 2
    ...
    private fun init(attrs: AttributeSet ?= null) {
        ...
        val ta = context.theme.obtainStyledAttributes(attrs, R.styleable.CustomBottomNavigationView, 0, 0)
        try {
            bg = ta.getColor(R.styleable.CustomBottomNavigationView_bgcolor, ContextCompat.getColor(context, R.color.light_mode_gray))
            mPaint!!.color = bg
        } finally {
            ta.recycle()
        }
